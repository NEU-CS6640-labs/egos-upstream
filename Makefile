...
DISK=FLASH
# [lab7]: TODO: change  "FSOFF" to "FSON" (when "FSON", "DISK" must be "SDCARD")
IFFS=FSOFF
...
COMMON = $(CFLAGS) $(LDFLAGS) $(INCLUDE) -D$(CPU_TYPE) -D CPU_CLOCK_RATE=65000000 -D$(SCHEDULER) -D$(SYSCALLFUNC) -D$(IFVM) -D$(DISK) -D$(IFFS)
